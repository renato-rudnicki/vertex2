...
class vertex_ai_pipeline:
    def __init__(self,
                 ...
                 PROJECT_ID: str = "prj-n-mlmachine-learning-8mm3",
                 # Replace the {prod-project_id} for your prod-project-id
                 PROD_PROJECT_ID: str = "prj-p-mlmachine-learning-n33a",
                 ...
                 DATAFLOW_SUBNET: str = "https://www.googleapis.com/compute/v1/projects/prj-n-shared-restricted-uyqc/regions/us-central1/subnetworks/sb-n-shared-restricted-us-central1",
                 ...
                 SERVICE_ACCOUNT: str = "586805422501-compute@developer.gserviceaccount.com",
                 # Replace the {prj_p_machine_learning_project_number} with your prj_p_machine_learning_project_number
                 PROD_SERVICE_ACCOUNT: str = "10495204433-compute@developer.gserviceaccount.com",
                 # Replace the {dataflow_sa} with your dataflow-sa from non-prod machine_learning_project
                 DATAFLOW_SA: str = "dataflow-sa@prj-n-mlmachine-learning-8mm3.iam.gserviceaccount.com",
                 ):
        ...
        self.Image = "us-central1-docker.pkg.dev/prj-c-mlartifacts-yzak/c-publish-artifacts/vertexpipeline:v2"
        ...
        self.deployment_config = {
            ...
            "encryption": 'projects/prj-p-kms-f2do/locations/us-central1/keyRings/sample-keyring/cryptoKeys/prj-p-mlmachine-learning',
    ...
    def execute(self):
        pipeline = aiplatform.PipelineJob(
            ...
            encryption_spec_key_name='projects/prj-n-kms-wgcb/locations/us-central1/keyRings/sample-keyring/cryptoKeys/prj-n-mlmachine-learning',
            parameter_values={
...
if __name__ == "__main__":
    pipeline = vertex_ai_pipeline(
        ...
        PROD_PROJECT_ID='prj-p-mlmachine-learning-n33a', \
        REGION="us-central1", \
        ...
        DATAFLOW_SUBNET="https://www.googleapis.com/compute/v1/projects/prj-n-shared-restricted-uyqc/regions/us-central1/subnetworks/sb-n-shared-restricted-us-central1", \
        JOB_NAME="census-ingest", \
        # Replace the {non_prod_project_number} with your Non-production Machine Learning Project Number
        SERVICE_ACCOUNT="586805422501-compute@developer.gserviceaccount.com", \
        # Replace the {prod_project_number} with your Production Machine Learning Project Number
        PROD_SERVICE_ACCOUNT="10495204433-compute@developer.gserviceaccount.com",
        # Replace the {prj-n-mlmachine-learning-id} with your Non-production Machine Learning Project ID
        DATAFLOW_SA="dataflow-sa@prj-n-mlmachine-learning-8mm3.iam.gserviceaccount.com",
    )
